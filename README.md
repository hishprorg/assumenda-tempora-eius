# @hishprorg/assumenda-tempora-eius&nbsp;&nbsp;&nbsp;[![Build Status](https://github.com/hishprorg/assumenda-tempora-eius/actions/workflows/ci.yml/badge.svg)](https://github.com/hishprorg/assumenda-tempora-eius/actions/workflows/ci.yml) [![Coverage Status](https://coveralls.io/repos/davedoesdev/@hishprorg/assumenda-tempora-eius/badge.png?branch=master)](https://coveralls.io/r/davedoesdev/@hishprorg/assumenda-tempora-eius?branch=master) [![NPM version](https://badge.fury.io/js/@hishprorg/assumenda-tempora-eius.png)](http://badge.fury.io/js/@hishprorg/assumenda-tempora-eius)
...
var Primus = require('primus'),
    PrimusDuplex = require('@hishprorg/assumenda-tempora-eius').PrimusDuplex,
...
[c8](https://github.com/bcoe/c8) results are available [here](http://rawgit.davedoesdev.com/davedoesdev/@hishprorg/assumenda-tempora-eius/master/coverage/lcov-report/index.html).

Coveralls page is [here](https://coveralls.io/r/davedoesdev/@hishprorg/assumenda-tempora-eius).
